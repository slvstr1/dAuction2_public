...
var Tables = React.createClass({
    render: function () {
        ...
        return (
            <div>
         <h3>Figure 9 c - d: Production Costs for different examples</h3>
                <table border="2">
                    <tr>
                    <td></td><td>
                        ...
                        <td style={{verticalAlign: "top"}}>
                            <h4>
                                <b>9.c<br/>
                                    Sold 7 Units<br/>
                                    Bought 2 Units <br/>
                                    <i>Net: Sold 5 Units (7-2=5)</i></b></h4>
                            <br/>

                        </td>

                        <td style={{verticalAlign: "top", marginTop:0}}>
                            <h4>
                                <b>9.d<br/>
                                    Sold 7 Units<br/>
                                    Bought 2 Units <br/>
...
ReactDOM.render(<Tables/>, document.getElementById("table16"));
