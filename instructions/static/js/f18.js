...
var Tables = React.createClass({
    render: function () {
        ...
        var vouchers_10 = vouchers.slice(0, 35);
        ...
        var totcost = vouchers_10[0].value + vouchers_10[1].value +vouchers_10[2].value +vouchers_10[3].value +vouchers_10[4].value + vouchers_10[5].value + vouchers_10[6].value;
        var totprofitprod = 19 - totcost;
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <div align="center" className="panel panel-warning">
                                    <strong>
                                      Total Cost</strong>   : {totcost} (this round)
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div align="center" className="panel panel-warning">
                                    <strong>
                                      PROFIT :  {totprofitprod}</strong>  (this round)
                                </div>
                            </td>
                        </tr>
                        </tbody>
...
ReactDOM.render(<Tables/>, document.getElementById("table18"));
