...
var Tables = React.createClass({
    render: function () {
        ...
        return (
            <div>
         <h3>Figure 9 b - c: Production Costs for different examples</h3>
                <table border="2">
                    <tr>
                        <td>
                            <div style={{
                        ...
                        <td style={{verticalAlign: "top"}}>
                            <h4>
                                <b>9.c<br/>
                                    Sold 7 Units<br/>
                                    Bought 2 Units <br/>
                                    <i>Net: Sold 5 Units (7-2=5)</i></b></h4></td>
                    </tr>
                </table>
...
ReactDOM.render(<Tables/>, document.getElementById("table15"));