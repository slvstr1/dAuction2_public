...
var Tables = React.createClass({
    render: function () {
        ...
        return (
            <div>
         <h3>Figure 14 d - e: Earnings Overview for different examples</h3>
                <table border="2">
                    <tr>
                    <td>
                        ...
                        <td style={{verticalAlign: "top"}}>
                            <h4>
                                <b>14.d<br/>
                                    ...
                                    Sold 2 Units <br/>
                                    Sold 8 Units<br/>
                                    <i>Net: Bought -3 Units (7-2-8=-3)</i></b></h4>
                        ...
                        <td style={{verticalAlign: "top"}}>
                            <h4>
                                <b>14.e<br/>
                                    ...
                                    Sold 8 Units<br/>
                                    Bought 10 Units <br/>
                                    <i>Net: Bought 7 Units (7-2-8+10=7)</i></b></h4></td>
                    </tr>
                </table>
...
ReactDOM.render(<Tables/>, document.getElementById("table24"));
