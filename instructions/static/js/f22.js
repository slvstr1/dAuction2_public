...
var Tables = React.createClass({
    render: function () {
        ...
        return (
            <div>
         <h3>Figure 14 b - c: Earnings Overview for different examples</h3>
                <table border="2">
                    <tr>
                        <td>
                            <div style={{
                        ...
                        <td style={{verticalAlign: "top"}}>
                            <h4>
                                <b>14.c<br/>
                                    Bought 7 Units<br/>
                                    Sold 2 Units<br/>
                                    <i>Net: Bought 5 Units (7-2=5)</i></b></h4></td>
                    </tr>
                </table>
...
ReactDOM.render(<Tables/>, document.getElementById("table22"));