...
var Tables = React.createClass({
    render: function () {
        ...
        // whats in vouchers:
        // [{'id': 1, 'idd': 1, 'value': 0.0, 'treatment_id': 1}, {'id': 2, 'idd': 2, 'value': 0.0, 'auction_id': 1},
        ...
        return (
            <div>
         <h3>Table 2: Retailers earnings</h3>
                <table border="2">
                    <tr>
                        <td>
                            <div style={{
                                ...
                                >
                                    ...
                                    <tbody>
                                    <tr>
                                        <td colSpan="4">Units that must be bought</td>
                                    </tr>
                                    <tr className="units">
                                    ...
                                    {tableMap1}
                                    <tr><td>...</td>{value}<td></td><td></td></tr>
                                    <tr><td width="70%">UNITS DEMANDED</td><td>{value}</td><td></td></tr>
                                    <tr><td>UNITS DEMANDED+1</td><td>0</td></tr>
                                    <tr><td>UNITS DEMANDED+2</td><td>0</td></tr>
                                    <tr><td>UNITS DEMANDED+3</td><td>0</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </td>
...
ReactDOM.render(<Tables/>, document.getElementById("table07"));
