...
var Tables = React.createClass({
    render: function () {
        ...
        // var auction_d = (($('#treatment_js').text()).replace(/\'/g, '\"')).replace(/\False/g, '0').replace(/\True/g, '1');
        ...
        return (
            <div>
         <h3>Table 3: Producers and production costs</h3>
                <table border="2">
                    <tr>
                        <td>
                            <div style={{
...
ReactDOM.render(<Tables/>, document.getElementById("table08"));
